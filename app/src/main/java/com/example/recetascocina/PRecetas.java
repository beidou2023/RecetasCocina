...
public class PRecetas extends AppCompatActivity {
    ...
    RecyclerView recyclerMisRecetas;
    String idUsuario;
    AdapterRecetas adapterMisRecetas;
    List<Object[]> items;
    ...
    private void verFavoritos(){
        String URL=Urls.REMOTO_MIS_RECETAS_URL;
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (success) {
                        ...
                        items = new ArrayList<>();
                        recyclerMisRecetas.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                        ...
                        adapterMisRecetas = new AdapterRecetas(PRecetas.this,items);
                        recyclerMisRecetas.setAdapter(adapterMisRecetas);

                        LinearLayoutManager layoutManager = new LinearLayoutManager(PRecetas.this, LinearLayoutManager.HORIZONTAL, false);
                        recyclerMisRecetas.setLayoutManager(layoutManager);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                    Toast.makeText(PRecetas.this, "Error en la respuesta del servidor", Toast.LENGTH_SHORT).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PRecetas.this, error.toString(), Toast.LENGTH_SHORT).show();
            }
        }) {
            @Nullable
            @Override
